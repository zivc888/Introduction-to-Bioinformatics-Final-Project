...
counts.xCell <- xCellAnalysis(counts)
...
tabyl(metadata[myclusters == 1,], Brodmann)
tabyl(metadata[myclusters == 2,], Brodmann)
...
ggplot(scores.df, aes(x=score1, y=score2, color=area)) + geom_point()
